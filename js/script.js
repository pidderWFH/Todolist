...
pwShowHide.forEach((hideIcon) => {
  hideIcon.addEventListener("click", () => {
    let pwd =
      hideIcon.parentElement.parentElement.querySelectorAll("#password");
    let pwd1 =
      hideIcon.parentElement.parentElement.querySelectorAll("#password1");
...
repwdShowHide.forEach((hideIcon) => {
  hideIcon.addEventListener("click", () => {
    let rePwd =
      hideIcon.parentElement.parentElement.querySelectorAll("#rePassword");
